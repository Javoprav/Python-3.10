...
Спасибо за проделанную работу. Отличный результат ﻿✅﻿

Просьба в следующий раз сдавать архивом.

Основной код программы так же можно вынести в функцию:
